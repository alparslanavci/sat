...
public class TestDao extends AbstractBaseDao{
    public String test(String id){
        ...
        return getNamedParameterJdbcTemplate().queryForObject(getSql("testSql"), paramSource, String.class);
    }

    public int testInsert(String test) {
        MapSqlParameterSource paramSource = new MapSqlParameterSource();
        paramSource.addValue("testParam", test);
        return getNamedParameterJdbcTemplate().update(getSql("testInsert"), paramSource);
    }
}
