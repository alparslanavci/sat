...
public class SwaggerConfig {
  ...
  public SwaggerGlobalSettings swaggerGlobalSettings() {
    ...
    swaggerGlobalSettings.setGlobalResponseMessages(
        springSwaggerConfig.defaultResponseMessages());
  ...
  public ApiPathProvider apiPathProvider() {
    ...
    apiPathProvider.setDefaultSwaggerPathProvider(
  ...
  private List<AuthorizationType> authorizationTypes() {
    ...
    LoginEndpoint loginEndpoint = new LoginEndpoint(
        apiPathProvider().getAppBasePath() + "/user/authenticate");
  ...
  private class ApiRelativeSwaggerPathProvider
      extends DefaultSwaggerPathProvider {
    @Override
